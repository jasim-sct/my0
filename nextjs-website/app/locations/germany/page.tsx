...
export const metadata: Metadata = {
  title: "Software Engineering & Web Development for Germany | Axio Future",
  description: "Software engineering, digital products, modern websites, and software infrastructure for businesses in Germany businesses.",
};
...
export default function Page() {
 ...
 <nav className="crumbs" aria-label="Breadcrumb"><Link href="/">Home</Link> / <Link href="/locations">Locations</Link> / <span aria-current="page">Germany</span></nav>
 <div className="hero-grid">
  <div><div className="eyebrow" data-anim>CET coverage</div>
   <h1 className="kin-h">Software engineering for German brands in Berlin, Munich and Hamburg</h1></div>
  <div><p className="lead" data-anim data-delay="120">Central European coverage, German localisation through native writers, and GDPR-aware data handling as standard.</p>
...
<section style={{"paddingTop":"0"}}><div className="wrap">
 <div className="hero-stats" style={{"marginTop":"0"}}>
  <div className="stat" data-anim><b>CET</b><small>Working hours</small></div>
...
<section><div className="wrap">
 <div className="s-head"><div><div className="eyebrow" data-anim>Services</div>
  <h2 className="kin-h" data-anim>What German clients hire us for</h2></div>
...
<section id="faq"><div className="wrap narrow">
 <div className="center"><div className="eyebrow" data-anim>FAQ</div><h2 data-anim>Working with us from Germany</h2></div>
 <div className="faq" style={{"marginTop":"1.8rem"}}><details className="glass" data-anim data-delay="0"><summary>Do you work with German businesses?</summary><p>Yes — Germany is one of our eight core markets. Central European coverage, German localisation through native writers, and GDPR-aware data handling as standard.</p></details><details className="glass" data-anim data-delay="40"><summary>What time zone do you work in for Germany clients?</summary><p>We build shifts around CET, so your morning is covered. That is written into the contract rather than promised on a call.</p></details><details className="glass" data-anim data-delay="80"><summary>Can you invoice in local currency?</summary><p>Yes. We invoice in USD by default and in GBP, EUR, CAD, AUD or AED on request. Payment by bank transfer, Wise, Payoneer or card.</p></details><details className="glass" data-anim data-delay="120"><summary>Do you understand German market specifics?</summary><p>We write in the correct English variant including date formats and spelling, and we have run campaigns, stores and Amazon accounts for German brands. Where local knowledge matters — tax, compliance, platform availability — we say what we know and what we do not.</p></details><details className="glass" data-anim data-delay="160"><summary>Is there a time zone surcharge?</summary><p>No. The rate is the rate regardless of which of our eight markets you are in.</p></details></div>
</div></section>
      </main>
    </SiteShell>
  );
