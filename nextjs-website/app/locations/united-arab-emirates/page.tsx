...
export const metadata: Metadata = {
  title: "Software Engineering & Web Development for United Arab Emirates | Axio Future",
  description: "Software engineering, digital products, modern websites, and software infrastructure for businesses in United Arab Emirates businesses.",
};
...
export default function Page() {
 ...
 <nav className="crumbs" aria-label="Breadcrumb"><Link href="/">Home</Link> / <Link href="/locations">Locations</Link> / <span aria-current="page">United Arab Emirates</span></nav>
 <div className="hero-grid">
  <div><div className="eyebrow" data-anim>GST coverage</div>
   <h1 className="kin-h">Software engineering for UAE brands in Dubai and Abu Dhabi</h1></div>
  <div><p className="lead" data-anim data-delay="120">Gulf Standard Time coverage, Arabic and English bilingual delivery, and experience with Noon as well as Amazon.ae.</p>
...
<section style={{"paddingTop":"0"}}><div className="wrap">
 <div className="hero-stats" style={{"marginTop":"0"}}>
  <div className="stat" data-anim><b>GST</b><small>Working hours</small></div>
...
<section><div className="wrap">
 <div className="s-head"><div><div className="eyebrow" data-anim>Services</div>
  <h2 className="kin-h" data-anim>What UAE clients hire us for</h2></div>
...
<section id="faq"><div className="wrap narrow">
 <div className="center"><div className="eyebrow" data-anim>FAQ</div><h2 data-anim>Working with us from United Arab Emirates</h2></div>
 <div className="faq" style={{"marginTop":"1.8rem"}}><details className="glass" data-anim data-delay="0"><summary>Do you work with UAE businesses?</summary><p>Yes — United Arab Emirates is one of our eight core markets. Gulf Standard Time coverage, Arabic and English bilingual delivery, and experience with Noon as well as Amazon.ae.</p></details><details className="glass" data-anim data-delay="40"><summary>What time zone do you work in for United Arab Emirates clients?</summary><p>We build shifts around GST, so your morning is covered. That is written into the contract rather than promised on a call.</p></details><details className="glass" data-anim data-delay="80"><summary>Can you invoice in local currency?</summary><p>Yes. We invoice in USD by default and in GBP, EUR, CAD, AUD or AED on request. Payment by bank transfer, Wise, Payoneer or card.</p></details><details className="glass" data-anim data-delay="120"><summary>Do you understand UAE market specifics?</summary><p>We write in the correct English variant including date formats and spelling, and we have run campaigns, stores and Amazon accounts for UAE brands. Where local knowledge matters — tax, compliance, platform availability — we say what we know and what we do not.</p></details><details className="glass" data-anim data-delay="160"><summary>Is there a time zone surcharge?</summary><p>No. The rate is the rate regardless of which of our eight markets you are in.</p></details></div>
</div></section>
      </main>
    </SiteShell>
  );
