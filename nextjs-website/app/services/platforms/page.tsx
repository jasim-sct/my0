...
export const metadata: Metadata = {
  title: "Platform Engineering & E-Commerce Architectures | Axio Future",
  description: "Scalable e-commerce engines, multi-tenant SaaS platforms, and custom transaction systems engineered for high reliability and scale.",
};
...
<section className="phero">
  <div className="wrap">
    <nav className="crumbs" aria-label="Breadcrumb"><Link href="/">Home</Link> / <Link href="/services">Capabilities</Link> / <span aria-current="page">Platforms</span></nav>
    <div className="hero-grid">
      <div>
        <div className="eyebrow" data-anim>Capabilities</div>
        <h1 className="kin-h">Platforms engineered for scale, transactions, and multiple users.</h1>
      </div>
      <div>
        ...
        <div className="hero-cta" data-anim data-delay="180">
          ...
          <Link className="btn" href="/projects/shop">
...
<section className="band">
  <div className="wrap">
    <div className="grid g2" style={{"background":"none","gap":"clamp(24px,4vw,56px)","alignItems":"center"}}>
      <div data-anim="left">
        <div className="eyebrow">Architectural Limits</div>
        <h2 className="kin-h">Why cookie-cutter platforms limit business growth</h2>
        <p className="lead">
      ...
      <div data-anim="right">
        <div className="rv zoom ar-43">
          <img className="ph" src="/assets/img/ph-workshop.webp" alt="Platform architecture and database modeling" width={1600} height={1000} loading="lazy" decoding="async" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="wrap">
    <div className="s-head">
      <div>
        ...
        <h2 className="kin-h" data-anim>Multi-user software and commerce architectures</h2>
      </div>
      <div>
...
<section className="band-dark">
  <div className="wrap">
    <div className="grid g2" style={{"background":"none","gap":"clamp(24px,4vw,56px)","alignItems":"center"}}>
      <div>
        <div className="eyebrow" data-anim>Evidence &amp; Demonstrations</div>
        <h2 className="kin-h" data-anim>Interactive platform architectures</h2>
        <p className="lead" data-anim>
        ...
        <div className="mk-row" data-anim>
          <Link href="/projects/shop" className="mk-chip">Lumen Commerce (Complete Store &amp; Checkout) →</Link>
          <Link href="/projects/volt" className="mk-chip">VOLT (SaaS Invoicing &amp; Billing Toggle) →</Link>
        </div>
      </div>
      <div className="rv ar-43" data-anim>
        <img className="ph" src="/assets/img/ph-desk.webp" alt="Platform development environment" width={1600} height={1000}  />
      </div>
    </div>
  </div>
</section>
...
<section className="band">
  <div className="wrap narrow">
    ...
    <div className="glass card" style={{"padding":"2rem"}} data-anim>
      <h3 style={{"marginBottom":"0.5rem"}}>Start the conversation</h3>
      ...
      <Link className="btn btn-primary" href="/contact"><span>Discuss your platform requirements</span><span className="gt">&rsaquo;</span></Link>
    </div>
  </div>
</section>
