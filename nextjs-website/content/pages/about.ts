...
<section><div class="wrap">
 <div class="grid g2" style="background:none;gap:clamp(24px,4vw,56px);align-items:center">
  <div data-anim="left">
   ...
   <h2 class="kin-h">Eight disciplines, one accountable team</h2>
   <p class="lead">The designer who draws your mark is in the room when it gets animated.
    The writer knows what the SEO plan is. The developer has the design tokens.
    Nothing gets translated twice.</p>
   <p class="lead">You get published pricing, a fixed delivery date, and one account manager
    who actually answers.</p>
   <ul class="tick" style="margin-top:1rem">
    <li>Fixed scope and price, never hourly on delivery work</li>
    <li>You own every account, file and line of code</li>
    <li>Thirty days notice, no exit fee, full handover</li>
...
<section class="band"><div class="wrap">
 <div class="s-head"><div><div class="eyebrow" data-anim>The pillars</div>
  <h2 class="kin-h" data-anim>What we actually do</h2></div><div></div></div>
 <div class="grid g4"><div class="glass card" data-anim data-delay="0">
   <span class="idx">01</span><h3>Build</h3><p>Websites, stores, apps and interfaces that ship and scale.</p>
   <p class="note">4 services</p></div><div class="glass card" data-anim data-delay="70">
   <span class="idx">02</span><h3>Brand</h3><p>Identity, print, film and motion that make people stop.</p>
   <p class="note">4 services</p></div><div class="glass card" data-anim data-delay="140">
   <span class="idx">03</span><h3>Grow</h3><p>SEO, social, ads and email measured in revenue, not reach.</p>
   <p class="note">4 services</p></div><div class="glass card" data-anim data-delay="210">
   <span class="idx">04</span><h3>Words</h3><p>Articles, copy, scripts and translation into five languages.</p>
   <p class="note">4 services</p></div><div class="glass card" data-anim data-delay="0">
   <span class="idx">05</span><h3>Operate</h3><p>Assistants, data, leads and support so you stop doing admin.</p>
   <p class="note">4 services</p></div><div class="glass card" data-anim data-delay="70">
   <span class="idx">06</span><h3>Automate</h3><p>Chatbots, workflows and AI systems that run without you.</p>
   <p class="note">3 services</p></div><div class="glass card" data-anim data-delay="140">
   <span class="idx">07</span><h3>Frontier</h3><p>No-code, Web3 and security — the skills nobody else offers.</p>
   <p class="note">3 services</p></div><div class="glass card" data-anim data-delay="210">
   <span class="idx">08</span><h3>Marketplace</h3><p>Amazon Seller Central, PPC, listings and account health.</p>
   <p class="note">1 services</p></div></div>
</div></section>

<section><div class="wrap narrow">
 <div class="eyebrow" data-anim>Honestly</div>
 <h2 class="kin-h" data-anim>What we are not</h2>
 <p class="lead" data-anim>We are not the cheapest. There is always someone on a marketplace who will
  build your site for $80, and if price is the only factor you should hire them.</p>
 <p class="lead" data-anim>We are not a 200-person network. If you need a global media buy across
  forty markets, that is WPP and we will tell you so.</p>
 <p class="lead" data-anim>We are not going to promise you page one in thirty days, a viral campaign,
  or an AI that runs your business. Those promises are how agencies get hired and how they lose clients
  four months later.</p>
</div></section>
