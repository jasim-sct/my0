export const title = 'AI automation: what actually works in a small business | Axon Future';
...
<section class="phero" style="padding-bottom:1.4rem"><div class="wrap narrow">
 <nav class="crumbs" aria-label="Breadcrumb"><a href="/">Home</a> / <a href="/">Blog</a> / <span aria-current="page">AI</span></nav>
 <div class="eyebrow" data-anim>AI · 9 min read</div>
 <h1 class="kin-h">AI automation: what actually works in a small business</h1>
 ...
 <div class="post-meta" data-anim data-delay="180">
  ...
  <div><strong>Axon Future Engineering</strong><small>Published 2026-05-29 · 9 min read</small></div>
 </div>
</div>
...
<section id="faq"><div class="wrap narrow">
 ...
 <div class="faq" style="margin-top:1.8rem"><details class="glass" data-anim data-delay="0"><summary>How much does an AI chatbot cost to build?</summary><p>$2,400 for a simple FAQ responder, $6,800 for a retrieval agent trained on your docs, $14,000+ for an action agent that writes to your systems. Model usage is separate and billed to your own provider account.</p></details><details class="glass" data-anim data-delay="40"><summary>Will AI replace my support team?</summary><p>It replaces the repetitive 70%, which lets the same team handle more volume and spend time on the hard cases. Every deployment we have done has changed what the team does, not how many people are on it.</p></details><details class="glass" data-anim data-delay="80"><summary>What is RAG?</summary><p>Retrieval-augmented generation. The bot searches your documents for relevant context, then answers using only that context. It is the difference between a bot that knows your business and one that guesses convincingly.</p></details></div>
</div></section>

<section><div class="wrap">
 <div class="post-nav" data-anim>
  <a class="glass card mini" href="/blog/shopify-vs-woocommerce-2026"><span class="dt-cat">← Previous</span><h3>Shopify vs WooCommerce in 2026: the honest comparison</h3></a>
  <a class="glass card mini" href="/blog/website-security-checklist-small-business" style="text-align:right"><span class="dt-cat">Next →</span><h3>The 12-point security checklist that prevents most breaches</h3></a>
 </div>
</div></section>
...
<section class="band"><div class="wrap">
 ...
 <div class="grid g3"><a class="glass card art-card" href="/blog/website-security-checklist-small-business" data-anim data-delay="0">
    ...
    <span class="dt-cta">Read · 8 min <span class="gt">&rsaquo;</span></span></div></a><a class="glass card art-card" href="/blog/how-to-brief-a-design-agency" data-anim data-delay="70">
    ...
    <span class="dt-cta">Read · 7 min <span class="gt">&rsaquo;</span></span></div></a><a class="glass card art-card" href="/blog/local-seo-checklist" data-anim data-delay="140">
    <div class="rv zoom ar-16 "><img class="ph " src="/assets/img/ph-writer.webp" alt="Long-form copy being drafted" width="1600" height="1000" sizes="(max-width:1000px) 92vw, 400px" loading="lazy" decoding="async" style="background-image:url(../assets/img/ph-writer-tiny.webp)"></div>
