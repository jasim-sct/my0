export const title = 'Software Engineering & Web Development for Germany | Axon Future';
export const description = 'Software engineering, digital products, modern websites, and software infrastructure for businesses in Germany businesses.';
export const mainHtml = `<section class="phero"><div class="wrap">
 ...
 <div class="hero-grid">
  <div><div class="eyebrow" data-anim>CET coverage</div>
   <h1 class="kin-h">Software engineering for German brands in Berlin, Munich and Hamburg</h1></div>
