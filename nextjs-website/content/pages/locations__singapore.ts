export const title = 'Software Engineering & Web Development for Singapore | Axio Future';
export const description = 'Software engineering, digital products, modern websites, and software infrastructure for businesses in Singapore businesses.';
export const mainHtml = `<section class="phero"><div class="wrap">
 ...
 <div class="hero-grid">
  <div><div class="eyebrow" data-anim>SGT coverage</div>
   <h1 class="kin-h">Software engineering for Singapore and APAC businesses</h1></div>
