export const title = 'Digital Agency for United Arab Emirates | Web, SEO, Brand & AI | Premium Agency';
...
<section id="faq"><div class="wrap narrow">
 <div class="center"><div class="eyebrow" data-anim>FAQ</div><h2 data-anim>Working with us from United Arab Emirates</h2></div>
 <div class="faq" style="margin-top:1.8rem"><details class="glass" data-anim data-delay="0"><summary>Do you work with UAE businesses?</summary><p>Yes — United Arab Emirates is one of our eight core markets. Gulf Standard Time coverage, Arabic and English bilingual delivery, and experience with Noon as well as Amazon.ae.</p></details><details class="glass" data-anim data-delay="40"><summary>What time zone do you work in for United Arab Emirates clients?</summary><p>We build shifts around GST, so your morning is covered. That is written into the contract rather than promised on a call.</p></details><details class="glass" data-anim data-delay="80"><summary>Can you invoice in local currency?</summary><p>Yes. We invoice in USD by default and in GBP, EUR, CAD, AUD or AED on request. Payment by bank transfer, Wise, Payoneer or card.</p></details><details class="glass" data-anim data-delay="120"><summary>Do you understand UAE market specifics?</summary><p>We write in the correct English variant including date formats and spelling, and we have run campaigns, stores and Amazon accounts for UAE brands. Where local knowledge matters — tax, compliance, platform availability — we say what we know and what we do not.</p></details><details class="glass" data-anim data-delay="160"><summary>Is there a time zone surcharge?</summary><p>No. The rate is the rate regardless of which of our eight markets you are in.</p></details></div>
</div></section>`;
