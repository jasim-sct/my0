export const title = 'Software Engineering & Web Development for United Kingdom | Axon Future';
export const description = 'Software engineering, digital products, modern websites, and software infrastructure for businesses in United Kingdom businesses.';
export const mainHtml = `<section class="phero"><div class="wrap">
 ...
 <div class="hero-grid">
  <div><div class="eyebrow" data-anim>GMT / BST coverage</div>
   <h1 class="kin-h">Software engineering for UK businesses from London to Manchester</h1></div>
