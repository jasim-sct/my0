export const title = 'Software Engineering & Web Development for United States | Axon Future';
export const description = 'Software engineering, digital products, modern websites, and software infrastructure for businesses in United States businesses.';
export const mainHtml = `<section class="phero"><div class="wrap">
 ...
 <div class="hero-grid">
  <div><div class="eyebrow" data-anim>EST / PST coverage</div>
   <h1 class="kin-h">Software engineering for US brands from Seattle to Miami</h1></div>
