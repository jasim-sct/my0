...
<section class="phero">
  <div class="wrap">
    <nav class="crumbs" aria-label="Breadcrumb"><a href="/">Home</a> / <a href="/services">Capabilities</a> / <span aria-current="page">Websites</span></nav>
    <div class="hero-grid">
      <div>
        <div class="eyebrow" data-anim>Primary Commercial Offer</div>
        <h1 class="kin-h">Professional business websites, built properly.</h1>
      </div>
      <div>
        ...
        <div class="hero-cta" data-anim data-delay="180">
          <a class="btn btn-primary" href="#packages">
  ...
  <div class="wrap">
    <div class="grid g2" style="background:none;gap:clamp(24px,4vw,56px);align-items:center">
      <div data-anim="left">
        ...
        <h2 class="kin-h">Why most business websites fail to generate results</h2>
        <p class="lead">
      ...
      <div data-anim="right">
        <div class="rv zoom ar-43">
          <img class="ph" src="/assets/img/ph-workshop.webp" alt="Website wireframing and performance planning" width="1600" height="1000" loading="lazy" decoding="async">
        </div>
      </div>
    </div>
  </div>
...
<section>
  <div class="wrap">
    <div class="s-head">
      <div>
        <div class="eyebrow" data-anim>Our Approach</div>
        <h2 class="kin-h" data-anim>Engineered for performance and search visibility</h2>
      </div>
      <div>
...
<section class="band-dark">
  <div class="wrap">
    <div class="grid g2" style="background:none;gap:clamp(24px,4vw,56px);align-items:center">
      <div>
        <div class="eyebrow" data-anim>Technology &amp; Evidence</div>
        <h2 class="kin-h" data-anim>Proven technology, working demonstrations</h2>
        <p class="lead" data-anim>
        ...
        <div class="mk-row" data-anim>
          <a href="/projects/terra" class="mk-chip">Terra &amp; Co (Brand &amp; Commerce) →</a>
          <a href="/projects/shop" class="mk-chip">Lumen Commerce Storefront →</a>
          <a href="/projects/dashboard" class="mk-chip">Northwind Analytics Dashboard →</a>
        </div>
      </div>
...
<section id="packages">
  <div class="wrap">
    <div class="s-head">
      <div>
        <div class="eyebrow" data-anim>Commercial Offerings</div>
        <h2 class="kin-h" data-anim>Transparent website packages</h2>
      </div>
      <div>
        <p class="lead" data-anim>
    ...
    <div class="grid g3">
      ...
      <article class="glass card plan" data-anim data-delay="0">
        ...
        <p class="note">Accessible digital starting point for local &amp; small businesses</p>
        <ul class="tick">
        ...
        <a class="btn btn-full" href="/contact"><span>Choose Starter</span></a>
      </article>
      ...
      <article class="glass card plan featured" data-anim data-delay="60">
        ...
        <p class="note">Primary offering for established businesses wanting leads</p>
        <ul class="tick">
        ...
        <a class="btn btn-primary btn-full" href="/contact"><span>Choose Business</span></a>
      </article>
      ...
      <article class="glass card plan" data-anim data-delay="120">
        ...
        <p class="note">Engineered for businesses actively pursuing organic search</p>
        <ul class="tick">
        ...
        <a class="btn btn-full" href="/contact"><span>Choose Growth</span></a>
      </article>
    </div>

    <!-- Hosting Transparency -->
    <div class="glass card" style="margin-top:2.5rem;padding:2rem;" data-anim>
      <div class="eyebrow">Hosting Transparency</div>
      ...
      <div class="grid g2" style="background:none;gap:1.5rem;">
        <div>
          <h4 style="margin-bottom:0.35rem;">First Year Included</h4>
        ...
        <div>
          <h4 style="margin-bottom:0.35rem;">Transparent Annual Renewal: ₹2,999–₹5,999/year</h4>
          <p style="color:var(--txt-dim);margin:0;">
...
<section id="faq">
  <div class="wrap narrow">
    ...
    <div class="faq" style="margin-top:1.8rem;">
      ...
      <details class="glass" data-anim data-delay="40">
